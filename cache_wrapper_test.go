...
import (
	...
	mocks "github.com/SuperJourney/cache_wrapper/mocks"
...
func Test_cacheWrapper_Get(t *testing.T) {
	...
	cacheEngine := mocks.NewKVCacheI(t)
	...
	grpcRequestFormatter.On("GetUniqKey", mock.Anything, mock.Anything, mock.Anything).Return([]byte("uniqKey"))
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, err := cacheWrapper.Request(context.TODO(), []interface{}{context.TODO(), tt.demoRequest}, []interface{}{&DemoResponse{}, errors.New("")})
